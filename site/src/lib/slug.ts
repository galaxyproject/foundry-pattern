...
//
// Content files live under content/<section>/<file>.md. Some sections (e.g. case/)
// encode reading-order with a one- or two-digit numeric prefix
// (`01-skills-package-not-source.md`) that must NOT appear in the route or in
// wiki-link targets. Blog posts are prefixed with a four-digit
...
/** content-relative path (e.g. "case/01-skills-package-not-source.md") -> route id ("case/skills-package-not-source"). */
